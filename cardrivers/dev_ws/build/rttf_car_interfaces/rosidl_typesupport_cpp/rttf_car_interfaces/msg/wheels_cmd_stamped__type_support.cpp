...
static const _WheelsCmdStamped_type_support_symbol_names_t _WheelsCmdStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rttf_car_interfaces, msg, WheelsCmdStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rttf_car_interfaces, msg, WheelsCmdStamped)),
  }
};
...
{
  return &::rttf_car_interfaces::msg::rosidl_typesupport_cpp::WheelsCmdStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rttf_car_interfaces, msg, WheelsCmdStamped)() {
  return get_message_type_support_handle<rttf_car_interfaces::msg::WheelsCmdStamped>();
}
