...
class PWMThrottle:
    ...
    def __init__(self, controller=None, max_pulse=300.0, min_pulse=490.0, zero_pulse=350.0):
        self.logger_name = "pwm.throttle"
        self.controller = controller
        self.max_pulse = max_pulse
        self.min_pulse = min_pulse
        self.zero_pulse = zero_pulse

        rclpy.logging.get_logger(self.logger_name).info("Init ESC")
        ...
        time.sleep(1)
        rclpy.logging.get_logger(self.logger_name).info('Finished init ESC')
    ...
    def set_speed(self, throttle):
        ...
        rclpy.logging.get_logger(self.logger_name).info('Set speed pulse to %s' % pulse)
